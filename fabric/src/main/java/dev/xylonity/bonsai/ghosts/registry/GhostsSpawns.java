...
public class GhostsSpawns {
    ...
    public static void init() {
        BiomeModifications.addSpawn(ctx -> GHOST_SPAWN_CONFIG.matches(ctx.getBiomeHolder()), MobCategory.CREATURE,
        ...
        BiomeModifications.addSpawn(ctx -> SMALL_GHOST_SPAWN_CONFIG.matches(ctx.getBiomeHolder()), MobCategory.CREATURE,
        ...
        BiomeModifications.addSpawn(ctx -> KODAMA_SPAWN_CONFIG.matches(ctx.getBiomeHolder()), MobCategory.CREATURE,
